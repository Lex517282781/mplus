(function() {
  ...
  var openPingduoduo = function() {
    window.location.href = 'pinduoduo://p.pinduoduo.com/2q1XClT4';
  }; // 打开淘宝
  ...
  _html5PlusEnv(function() {
    ...
    openTaobao = function() {
      ...
      if (_checkApp(info)) {
        ...
        window.plus.runtime.openURL('http://www.taobao.com');
      }
    };
    ...
    openPingduoduo = function(config) {
      ...
      config = config || {};
      var url = config.url || 'https://p.pinduoduo.com/2q1XClT4';
      if (_checkApp(info)) {
        if (_isAndroid()) {
          window.plus.runtime.launchApplication(
            {
